...
def train(model,
    ...
    logger = logging.getLogger('combined_penalization')
...
if __name__ == '__main__':
    ...
    logging_file = osp.join(log_dir, 'combined_penalization.log')
    logger = logging.getLogger('combined_penalization')
    ...
    stats_path = osp.join(ckpt_dir, 'combined_penalization_train_stats.pkl')
