...
# sgd + l2
python3 l2_penalization.py -lr 1e-2 -l2 1e-5 -n 30 -d FashionMNIST -b 256 -m LeNet -r "model=LeNet,dataset=FashionMNIST,l2,id=1" --milestones 10 20 --lr_gamma 0.25 -reruns 3
# sgd + htr
...
# sgd + l2
python3 l2_penalization.py -lr 1e-1 -l2 1e-3 -n 50 -d SVHN -b 256 -m LeNet -r "model=LeNet,dataset=SVHN,l2,id=1" --milestones 20 35 --lr_gamma 0.25 -reruns 3
# sgd + htr
...
# sgd + l2
python3 l2_penalization.py -lr 1e-2 -l2 1e-4 -n 50 -d CIFAR100 -b 64 -m VGG11_bn -r "model=VGG11_bn,dataset=CIFAR100,l2,id=1" --milestones 20 35 --lr_gamma 0.25 -reruns 3
# sgd + htr
...
# sgd + l2
python3 l2_penalization.py -lr 1e-2 -l2 1e-4 -n 40 -d CIFAR10 -b 64 -m ResNet18 -r "model=ResNet18,dataset=CIFAR10,l2,id=1" --milestones 20 30 --lr_gamma 0.25 -reruns 3
# sgd + htr
